...
export class RefreshTokenStrategy extends PassportStrategy(
      ...
      jwtFromRequest: ExtractJwt.fromExtractors([
        ...
        (req: Request) => {
          ...
          if (req && req.cookies) {
            ...
            if (token) {
              console.log(
                '🔐 [REFRESH-STRATEGY] Token extracted from cookies ✓',
              );
              return token;
            }
          }
          console.log(
            '⚠️ [REFRESH-STRATEGY] No token in cookies, checking body...',
          );
          ...
          console.log(
            '❌ [REFRESH-STRATEGY] No token found in cookies or body',
          );
          return null;
        },
      ]),
  ...
  async validate(req: Request, payload: any) {
    ...
    console.log(
      '🔄 [REFRESH-STRATEGY] Cookies received:',
    ...
    console.log(
      '✅ [REFRESH-STRATEGY] JWT signature valid (verified by passport-jwt)',
    );
