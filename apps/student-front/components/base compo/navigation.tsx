    ...
    return (
        <div className='absolute top-0 w-full z-50 page-margin'>
            ...
            >
                ...
                >
                    <Image src={Logo} alt="Logo" className='w-[80px] m-1' />
                </motion.div>
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Avatar className="cursor-pointer border-2 border-transparent hover:border-blue-500 transition-colors">
                                    <AvatarFallback className='bg-blue-300 border border-blue-700 text-blue-700 font-bold'>CN</AvatarFallback>
                                </Avatar>
                            </DropdownMenuTrigger>
                        ...
                        <div className="bg-white/95 dark:bg-gray-950/95 backdrop-blur-3xl border border-gray-200 dark:border-gray-800 rounded-3xl p-6 shadow-2xl flex flex-col gap-6">
                            ...
                            >
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-xs text-blue-600 dark:text-blue-400 font-medium">Click to login</span>
                                </div>
