        ...
        <footer className="relative border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 pt-16 pb-8 overflow-hidden">
            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    {/* Brand Section */}
                    <div className="space-y-4 lg:col-span-1 border-r-0 lg:border-r border-gray-200 dark:border-gray-800/50 pr-8">
                        <motion.div
                    ...
                    <div className="space-y-4 lg:col-span-1">
                        <h4 className="font-semibold text-gray-900 dark:text-white">Subscribe to Newsletter</h4>
                        ...
                        <div className="flex flex-col space-y-2 mt-2">
                            <Input
                                ...
                                className="bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-800 focus-visible:ring-blue-500"
                            />
